import {
    FETCH_PHONES_START, FETCH_PHONES_SUCCESS, FETCH_PHONES_FAILED, SEARCH_PHONE,
...
import {
    fetchPhonesAPI, loadMorePhonesAPI,
    fetchPhoneByIdAPI, searchPhoneApi
} from "../../api";
...
export const searchPhone = (text) => (dispatch) => {
    const res = searchPhoneApi(text);
    dispatch({type: SEARCH_PHONE, payload: res});
}
